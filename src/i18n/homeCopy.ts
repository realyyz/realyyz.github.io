...
export const HOME_COPY: Record<SupportedLocale, HomeCopy> = {
  ...
  vi: {
    quote: "Thời gian của bạn có hạn, vì vậy đừng lãng phí nó bằng cách sống cuộc sống của người khác. Đừng để bản thân bị kẹt trong dogma -- đó là sống với kết quả của suy nghĩ của người khác. Đừng để tiếng ồn của ý kiến của người khác nhấn chìm giọng nói nội tâm của bạn. Và quan trọng nhất, hãy có lòng can đảm theo đuổi trái tim và直觉. Họ somehow đã biết rõ điều bạn thực sự muốn trở thành. Mọi thứ khác đều là thứ hai.",
  },
  ja: {
